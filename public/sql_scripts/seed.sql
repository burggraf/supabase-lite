...
-- Role memberships
--
GRANT anon TO authenticator WITH INHERIT FALSE GRANTED BY
    postgres;

GRANT anon TO postgres WITH ADMIN OPTION,
INHERIT TRUE GRANTED BY
    postgres;

GRANT authenticated TO authenticator WITH INHERIT FALSE GRANTED BY
    postgres;
...
GRANT authenticator TO supabase_storage_admin WITH INHERIT FALSE GRANTED BY
    postgres;

GRANT pg_create_subscription TO postgres WITH INHERIT TRUE GRANTED BY
    postgres;
...
GRANT pg_read_all_data TO supabase_etl_admin WITH INHERIT TRUE GRANTED BY
    postgres;

GRANT pg_read_all_data TO supabase_read_only_user WITH INHERIT TRUE GRANTED BY
    postgres;
...
GRANT service_role TO authenticator WITH INHERIT FALSE GRANTED BY
    postgres;
...
GRANT supabase_realtime_admin TO postgres WITH INHERIT TRUE GRANTED BY
    postgres;
