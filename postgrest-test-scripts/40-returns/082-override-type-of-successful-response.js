...
// Test: Override type of successful response
// Function: returns
// Example ID: override-type-of-successful-response
...
async function runTest() {
  ...
  console.log(`Running test: 082-override-type-of-successful-response`);
  console.log(`Function: returns`);
  console.log(`Test: Override type of successful response`);
  console.log('='.repeat(60));
  ...
  .returns<Array<MyType>>()
    ...
    if (data && expectedResponse && expectedResponse.data) {
      ...
      return {
        testId: '082-override-type-of-successful-response',
        functionId: 'returns',
