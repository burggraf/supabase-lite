...
// Test: Override type of object response
// Function: returns
// Example ID: override-type-of-object-response
...
async function runTest() {
  ...
  console.log(`Running test: 083-override-type-of-object-response`);
  console.log(`Function: returns`);
  console.log(`Test: Override type of object response`);
  console.log('='.repeat(60));
  ...
  .returns<MyType>()
    ...
    if (data && expectedResponse && expectedResponse.data) {
      ...
      return {
        testId: '083-override-type-of-object-response',
        functionId: 'returns',
