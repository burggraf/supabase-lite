...
// Test: Order parent table by a referenced table
// Function: order
// Example ID: order-parent-table-by-a-referenced-table
...
async function runTest() {
  ...
  console.log(`Running test: 073-order-parent-table-by-a-referenced-table`);
  console.log(`Function: order`);
  console.log(`Test: Order parent table by a referenced table`);
  console.log('='.repeat(60));
