...
// Test: Get the execution plan with analyze and verbose
// Function: explain
// Example ID: get-execution-plan-with-analyze-and-verbose
...
async function runTest() {
  ...
  console.log(`Running test: 089-get-execution-plan-with-analyze-and-verbose`);
  console.log(`Function: explain`);
  console.log(`Test: Get the execution plan with analyze and verbose`);
  console.log('='.repeat(60));
