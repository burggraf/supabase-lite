...
// Test: Create a record and return it
// Function: insert
// Example ID: create-a-record-and-return-it
...
async function runTest() {
  ...
  console.log(`Running test: 015-create-a-record-and-return-it`);
  console.log(`Function: insert`);
  console.log(`Test: Create a record and return it`);
  console.log('='.repeat(60));
