...
// Test: Filter by values within a JSON column
// Function: using-filters
// Example ID: filter-by-value-within-json-column
...
async function runTest() {
  ...
  console.log(`Running test: 034-filter-by-value-within-json-column`);
  console.log(`Function: using-filters`);
  console.log(`Test: Filter by values within a JSON column`);
  console.log('='.repeat(60));
