...
// Test: Filter referenced tables
// Function: using-filters
// Example ID: filter-referenced-tables
...
async function runTest() {
  ...
  console.log(`Running test: 035-filter-referenced-tables`);
  console.log(`Function: using-filters`);
  console.log(`Test: Filter referenced tables`);
  console.log('='.repeat(60));
