...
// Test: With `upsert()`
// Function: db-modifiers-select
// Example ID: with-upsert
...
async function runTest() {
  ...
  console.log(`Running test: 070-with-upsert`);
  console.log(`Function: db-modifiers-select`);
  console.log(`Test: With `upsert()``);
  console.log('='.repeat(60));
