...
// Test: Update a record and return it
// Function: update
// Example ID: update-a-record-and-return-it
...
async function runTest() {
  ...
  console.log(`Running test: 018-update-a-record-and-return-it`);
  console.log(`Function: update`);
  console.log(`Test: Update a record and return it`);
  console.log('='.repeat(60));
