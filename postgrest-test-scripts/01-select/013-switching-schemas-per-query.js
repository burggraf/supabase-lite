...
// Test: Switching schemas per query
// Function: select
// Example ID: switching-schemas-per-query
...
async function runTest() {
  ...
  console.log(`Running test: 013-switching-schemas-per-query`);
  console.log(`Function: select`);
  console.log(`Test: Switching schemas per query`);
  console.log('='.repeat(60));
  ...
  try {
    ...
    // Setup SQL
    const setupSQL = `drop table if exists myschema.mytable;
