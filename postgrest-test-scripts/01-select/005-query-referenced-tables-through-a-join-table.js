...
// Test: Query referenced tables through a join table
// Function: select
// Example ID: query-referenced-tables-through-a-join-table
...
async function runTest() {
  ...
  console.log(`Running test: 005-query-referenced-tables-through-a-join-table`);
  console.log(`Function: select`);
  console.log(`Test: Query referenced tables through a join table`);
  console.log('='.repeat(60));
