...
// Test: Querying referenced table with inner join
// Function: select
// Example ID: querying-referenced-table-with-inner-join
...
async function runTest() {
	...
	console.log(`Running test: 012-querying-referenced-table-with-inner-join`)
	console.log(`Function: select`)
	console.log(`Test: Querying referenced table with inner join`)
	console.log('='.repeat(60))
	...
	try {
		...
		// Setup SQL
		const setupSQL = `drop table if exists orchestral_sections;
