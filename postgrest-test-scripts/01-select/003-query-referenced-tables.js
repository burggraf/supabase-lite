...
// Test: Query referenced tables
// Function: select
// Example ID: query-referenced-tables
...
async function runTest() {
  ...
  console.log(`Running test: 003-query-referenced-tables`);
  console.log(`Function: select`);
  console.log(`Test: Query referenced tables`);
  console.log('='.repeat(60));
