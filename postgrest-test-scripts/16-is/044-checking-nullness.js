...
// Test: Checking for nullness, true or false
// Function: is
// Example ID: checking-nullness
...
async function runTest() {
  ...
  console.log(`Running test: 044-checking-nullness`);
  console.log(`Function: is`);
  console.log(`Test: Checking for nullness, true or false`);
  console.log('='.repeat(60));
