...
// Test: On `jsonb` columns
// Function: contains
// Example ID: on-jsonb-columns
...
async function runTest() {
  ...
  console.log(`Running test: 048-on-jsonb-columns`);
  console.log(`Function: contains`);
  console.log(`Test: On `jsonb` columns`);
  console.log('='.repeat(60));
