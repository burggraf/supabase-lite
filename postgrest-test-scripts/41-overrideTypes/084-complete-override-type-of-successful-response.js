...
// Test: Complete Override type of successful response
// Function: overrideTypes
// Example ID: complete-override-type-of-successful-response
...
async function runTest() {
  ...
  console.log(`Running test: 084-complete-override-type-of-successful-response`);
  console.log(`Function: overrideTypes`);
  console.log(`Test: Complete Override type of successful response`);
  console.log('='.repeat(60));
  ...
  .overrideTypes<Array<MyType>, { merge: false }>()
    ...
    if (data && expectedResponse && expectedResponse.data) {
      ...
      return {
        testId: '084-complete-override-type-of-successful-response',
