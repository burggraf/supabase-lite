...
// Test: Partial Override type of object response
// Function: overrideTypes
// Example ID: partial-override-type-of-object-response
...
async function runTest() {
  ...
  console.log(`Running test: 087-partial-override-type-of-object-response`);
  console.log(`Function: overrideTypes`);
  console.log(`Test: Partial Override type of object response`);
  console.log('='.repeat(60));
  ...
  .overrideTypes<{ status: "A" | "B" }>()
    ...
    if (data && expectedResponse && expectedResponse.data) {
      ...
      return {
        testId: '087-partial-override-type-of-object-response',
