...
// Test: Partial Override type of successful response
// Function: overrideTypes
// Example ID: partial-override-type-of-successful-response
...
async function runTest() {
  ...
  console.log(`Running test: 086-partial-override-type-of-successful-response`);
  console.log(`Function: overrideTypes`);
  console.log(`Test: Partial Override type of successful response`);
  console.log('='.repeat(60));
  ...
  .overrideTypes<Array<{ status: "A" | "B" }>>()
    ...
    if (data && expectedResponse && expectedResponse.data) {
      ...
      return {
        testId: '086-partial-override-type-of-successful-response',
