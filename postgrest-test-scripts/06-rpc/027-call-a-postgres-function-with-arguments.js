...
// Test: Call a Postgres function with arguments
// Function: rpc
// Example ID: call-a-postgres-function-with-arguments
...
async function runTest() {
  ...
  console.log(`Running test: 027-call-a-postgres-function-with-arguments`);
  console.log(`Function: rpc`);
  console.log(`Test: Call a Postgres function with arguments`);
  console.log('='.repeat(60));
  ...
  try {
    ...
    // Setup SQL
    const setupSQL = `create function echo(say text) returns text as $
  select say;
$ language sql;`;
    if (setupSQL.trim()) {
