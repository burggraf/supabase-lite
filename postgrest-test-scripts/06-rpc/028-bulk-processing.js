...
async function runTest() {
  ...
  console.log(`Running test: 028-bulk-processing`);
  console.log(`Function: rpc`);
  console.log(`Test: Bulk processing`);
  console.log('='.repeat(60));
  ...
  try {
    ...
    // Setup SQL
    const setupSQL = `create function add_one_each(arr int[]) returns int[] as $
