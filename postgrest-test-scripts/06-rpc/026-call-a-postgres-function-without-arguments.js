...
// Test: Call a Postgres function without arguments
// Function: rpc
// Example ID: call-a-postgres-function-without-arguments
...
async function runTest() {
  ...
  console.log(`Running test: 026-call-a-postgres-function-without-arguments`);
  console.log(`Function: rpc`);
  console.log(`Test: Call a Postgres function without arguments`);
  console.log('='.repeat(60));
  ...
  try {
    ...
    // Setup SQL
    const setupSQL = `create function hello_world() returns text as $
  select 'Hello world';
$ language sql;`;
    if (setupSQL.trim()) {
