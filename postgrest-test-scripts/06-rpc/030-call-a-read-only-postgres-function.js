...
// Test: Call a read-only Postgres function
// Function: rpc
// Example ID: call-a-read-only-postgres-function
...
async function runTest() {
  ...
  console.log(`Running test: 030-call-a-read-only-postgres-function`);
  console.log(`Function: rpc`);
  console.log(`Test: Call a read-only Postgres function`);
  console.log('='.repeat(60));
