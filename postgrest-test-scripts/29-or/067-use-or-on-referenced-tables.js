...
// Test: Use `or` on referenced tables
// Function: or
// Example ID: use-or-on-referenced-tables
...
async function runTest() {
  ...
  console.log(`Running test: 067-use-or-on-referenced-tables`);
  console.log(`Function: or`);
  console.log(`Test: Use `or` on referenced tables`);
  console.log('='.repeat(60));
...
values
  ...
  .or('section_id.eq.1,name.eq.guzheng', { referencedTable: 'instruments' })
    ...
    if (data && expectedResponse && expectedResponse.data) {
      ...
      return {
        testId: '067-use-or-on-referenced-tables',
        functionId: 'or',
