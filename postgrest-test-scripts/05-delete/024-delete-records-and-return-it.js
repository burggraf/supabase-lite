...
// Test: Delete a record and return it
// Function: delete
// Example ID: delete-records-and-return-it
...
async function runTest() {
  ...
  console.log(`Running test: 024-delete-records-and-return-it`);
  console.log(`Function: delete`);
  console.log(`Test: Delete a record and return it`);
  console.log('='.repeat(60));
